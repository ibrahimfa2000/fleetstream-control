...
const DeviceCard = ({ device, telemetry, subscription, onClick }: DeviceCardProps) => {
  ...
  return (
    <Card className="group hover:border-primary/50 transition-all hover:shadow-glow cursor-pointer bg-card/50 backdrop-blur-sm">
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-border/50">
          ...
          <Button variant="ghost" size="sm" onClick={onClick} className="hover:text-primary">
            Details →
          </Button>
        </div>
      </CardContent>
